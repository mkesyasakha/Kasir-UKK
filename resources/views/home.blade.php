        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <p>Selamat datang di dashboard aplikasi kami. Anda berhasil masuk sebagai {{ Auth::user()->email }}.</p>
                    <p>Mulailah menjelajahi aplikasi atau gunakan fitur yang ada di menu.</p>

                    <!-- Menyisipkan SVG secara inline -->
                    <div class="my-4">
